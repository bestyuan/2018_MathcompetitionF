...
def GetInfo_ave_rate(puck,gate):
    ...
    rate.to_csv("use_rate_problem1.csv", encoding="gb2312", index=None)
...
if __name__=="__main__":
    ...
    for loopF in range(9,10):
        ...
        Sorted_PucksSheet=sorted(PucksSheet,key=lambda la:la["到达时间"])
